...
<title>nicenet.ActivationFunction API documentation</title>
...
<article id="content">
<header>
<h1 class="title">Module <code>nicenet.ActivationFunction</code></h1>
</header>
...
<dl>
<dt id="nicenet.ActivationFunction.ActivationFunction"><code class="flex name class">
<span>class <span class="ident">ActivationFunction</span></span>
<span>(</span><span>function_name)</span>
</code></dt>
<dd>
...
<pre><code class="python">class ActivationFunction(Generic[T]):
    def __init__(self, function_name):
        if function_name == &#39;sigmoid&#39;:
            self.activation_function = self._sigmoid
        elif function_name == &#39;tanh&#39;:
...
<h3>Methods</h3>
<dl>
<dt id="nicenet.ActivationFunction.ActivationFunction.activate"><code class="name flex">
<span>def <span class="ident">activate</span></span>(<span>self, x: ~T, derivative=False) ‑> ~T</span>
</code></dt>
<dd>
<div class="desc"></div>
<details class="source">
...
<pre><code class="python">def activate(self, x: T, derivative=False) -&gt; T:
    if derivative:
        return self.activation_function(x, derivative=True)
    return self.activation_function(x)</code></pre>
</details>
</dd>
</dl>
</dd>
...
<ul>
<li>
<h4><code><a title="nicenet.ActivationFunction.ActivationFunction" href="#nicenet.ActivationFunction.ActivationFunction">ActivationFunction</a></code></h4>
<ul class="">
<li><code><a title="nicenet.ActivationFunction.ActivationFunction.activate" href="#nicenet.ActivationFunction.ActivationFunction.activate">activate</a></code></li>
</ul>
</li>
</ul>
</li>
